  ...
  function applyStatus(s) {
    ...
    if ($("stat-urls") && s.urls) {
      ...
      const https = s.urls.domain_https || (s.panel_domain && s.ssl_active && typeof publicUrl === "function"
        ...
        : s.urls.domain_https);
      if (ip) parts.push(`<div><span class="text-muted" style="font-size:11px; margin-right:4px;">IP:</span><a href="${ip}" target="_blank" rel="noopener">${ip}</a></div>`);
      if (http) parts.push(`<div><span class="text-muted" style="font-size:11px; margin-right:4px;">HTTP:</span><a href="${http}" target="_blank" rel="noopener">${http}</a></div>`);
      if (https) parts.push(`<div><span class="text-muted" style="font-size:11px; margin-right:4px;">HTTPS:</span><a href="${https}" target="_blank" rel="noopener">${https}</a></div>`);
