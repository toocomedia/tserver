        ...
        <div class="tabs-panel ${currentTab === "overview" ? "is-active" : ""}" data-tab-panel="overview">
          <div class="php-cards-grid">
            ...
            ${card(t("site_details") || "Site Details", `
              ...
              ${spec(t("preset"), `<span class="badge-minimal badge-minimal--active"><i class="devicon-${isWp ? 'wordpress-plain' : isFilament ? 'filamentphp-plain' : isLaravel ? 'laravel-original' : 'php-plain'}" aria-hidden="true"></i>${esc(isWp ? t("wordpress") : isFilament ? t("filament") : isLaravel ? t("laravel") : t("plain_php"))}</span>`)}
