  ...
  var AiHelper = {
    ...
    _injectDOM: function () {
      ...
      drawer.innerHTML = [
        ...
        '        <button type="button" class="btn btn--danger btn--sm" id="ai-helper-stop-btn" style="display: none; height: 30px; padding: 0 10px; font-size: 11px; min-width: auto;" title="Stop generation">',
        '          <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="4" width="16" height="16" rx="2"/></svg> Stop',
        '        </button>',
        '        <button type="submit" class="btn btn--primary btn--sm" id="ai-helper-send-btn" style="width: 30px; height: 30px; padding: 0; min-width: 30px;" title="Send message (Enter)">',
