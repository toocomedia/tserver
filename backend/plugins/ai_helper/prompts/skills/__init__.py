...
for skill in (APP_DEPLOY_SKILL, APP_INSPECT_SKILL, APP_REDEPLOY_SKILL, APP_RECOVERY_SKILL, DATABASE_SKILL, ERROR_DIAG_SKILL, FILE_EXPLORER_SKILL, SECURITY_AUDIT_SKILL):
