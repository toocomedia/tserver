...
2. When root cause is identified (such as missing environment variables like `KAFKA_BROKERS`, `CLICKHOUSE_URL`, database URL, port, or framework secrets on single apps or official stacks):
