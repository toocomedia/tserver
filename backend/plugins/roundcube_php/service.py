...
class RoundcubePhpService:
    ...
    def read_config_file(self) -> dict[str, Any]:
        ...
        return roundcube_config_manager.read_config_file()

    def get_settings(self) -> dict[str, Any]:
        from plugins.roundcube_php.config_manager import roundcube_config_manager
        return roundcube_config_manager.get_settings()

    def sync_config_file(self) -> None:
        from plugins.roundcube_php.config_manager import roundcube_config_manager
        settings = self.get_settings()
        php_code = roundcube_config_manager.generate_config_php(settings)
        roundcube_config_manager.write_config_file(php_code)

    def update_settings(self, **new_settings: Any) -> dict[str, Any]:
        from plugins.roundcube_php.config_manager import roundcube_config_manager
        return roundcube_config_manager.save_settings(**new_settings)
