"""Legacy stack catalog used only to repair deployments created before manifests persisted."""
...
# Existing installations may still refer to a historical catalog id. New stack
# plans never read this registry: they persist their validated manifest instead.
...
def clear_catalog() -> None:
    """Clears test-only and legacy entries."""
    _CATALOG.clear()
